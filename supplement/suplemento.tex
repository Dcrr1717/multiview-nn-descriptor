...
\begin{theorem}[Estabilidad de los diagramas de persistencia; Cohen-Steiner et al., 2007, forma para Vietoris--Rips en Chazal et al., 2014]
\label{thm:stability}
...
\caption{Solapamiento entre las vistas $X_1$ y $X_2$ por dominio. Correlación de Spearman entre cada par de rasgos sobre las $n{=}40$ redes; los pares con algún rasgo constante no son evaluables.}
...
CIFAR-10 & 110 & 0,235 & [0,11; 0,47] & 0,829 & 41 (37,3\,\%) & 55,5\,\% & 9,1\,\% \\
CIFAR-100 & 120 & 0,271 & [0,14; 0,36] & 0,696 & 22 (18,3\,\%) & 65,8\,\% & 6,7\,\% \\
SVHN & 110 & 0,239 & [0,12; 0,39] & 0,548 & 33 (30,0\,\%) & 55,5\,\% & 0,0\,\% \\
...
\subsection*{CIFAR-10}
Rango de exactitud de prueba en el dominio: 42,8 puntos porcentuales en total (11,8 entre perceptrones multicapa y 20,7 entre redes convolucionales).

\begin{table}[H]\centering\scriptsize\setlength{\tabcolsep}{3pt}
\caption{CIFAR-10, Población completa ($n{=}40$). Media [IC 95\,\%] sobre la validación cruzada repetida (AUC familiar y $\tau$) y sobre 300 remuestreos bootstrap (AUC por pares); $d$ de Cohen y prueba de Mann--Whitney entre familias extremas. Contrastes significativos tras Benjamini--Hochberg: 10/10 (Bonferroni: 10).}
...
$X_1$ (grafo funcional) & 0,854 [0,81; 0,89] & 0,734 [0,55; 0,87] & 0,442 [0,37; 0,51] & $<$0,0001 & 2,17 [1,21; 4,28] & 0,90 & 0,0008 \\
$X_2$ (homología persistente) & 0,869 [0,83; 0,92] & 0,656 [0,47; 0,84] & 0,316 [0,27; 0,37] & 0,0045 & 2,49 [1,63; 4,90] & 0,90 & 0,0008 \\
$X_3^{(\mathrm{c})}$ (pesos iguales) & 0,949 [0,92; 0,97] & 0,755 [0,55; 0,91] & 0,522 [0,46; 0,58] & $<$0,0001 & 3,34 [2,34; 5,89] & 0,98 & 0,0002 \\
$X_3^{(\mathrm{a})}$ (adaptativa) & 0,948 [0,91; 0,98] & 0,731 [0,58; 0,89] & 0,444 [0,36; 0,50] & 0,0003 & 2,44 [1,30; 4,84] & 0,90 & 0,0008 \\
$X_3^{(\mathrm{r})}$ (adaptativa, ponderación por rangos) & 0,948 [0,91; 0,98] & 0,733 [0,55; 0,89] & 0,444 [0,36; 0,50] & 0,0003 & 2,44 [1,41; 4,88] & 0,90 & 0,0008 \\
\bottomrule\end{tabular}}\end{table}

\begin{table}[H]\centering\scriptsize\setlength{\tabcolsep}{3pt}
\caption{CIFAR-10, Solo perceptrones multicapa ($n{=}30$). Media [IC 95\,\%] sobre la validación cruzada repetida (AUC familiar y $\tau$) y sobre 300 remuestreos bootstrap (AUC por pares); $d$ de Cohen y prueba de Mann--Whitney entre familias extremas. Contrastes significativos tras Benjamini--Hochberg: 10/10 (Bonferroni: 7).}
\resizebox{\linewidth}{!}{\begin{tabular}{l c c c c c c c}\toprule
Descriptor & AUC familiar & AUC por pares & $\tau$ de Kendall & $p_\tau$ & $d$ de Cohen & $r_{\mathrm{MW}}$ & $p_{\mathrm{MW}}$ \\\midrule
$X_1$ (grafo funcional) & 0,810 [0,75; 0,86] & 0,727 [0,55; 0,87] & 0,430 [0,28; 0,54] & $<$0,0001 & 2,15 [1,61; 4,53] & 1,00 & 0,0006 \\
$X_2$ (homología persistente) & 0,828 [0,77; 0,89] & 0,600 [0,37; 0,79] & 0,184 [0,05; 0,29] & 0,0401 & 1,22 [0,47; 2,44] & 0,80 & 0,0111 \\
$X_3^{(\mathrm{c})}$ (pesos iguales) & 0,898 [0,85; 0,94] & 0,728 [0,56; 0,89] & 0,491 [0,37; 0,59] & $<$0,0001 & 1,82 [0,76; 4,71] & 0,76 & 0,0175 \\
$X_3^{(\mathrm{a})}$ (adaptativa) & 0,920 [0,88; 0,97] & 0,714 [0,54; 0,87] & 0,441 [0,28; 0,57] & $<$0,0001 & 1,99 [1,24; 3,46] & 0,92 & 0,0023 \\
$X_3^{(\mathrm{r})}$ (adaptativa, ponderación por rangos) & 0,920 [0,88; 0,97] & 0,711 [0,51; 0,89] & 0,441 [0,28; 0,57] & $<$0,0001 & 1,99 [1,31; 3,65] & 0,92 & 0,0023 \\
\bottomrule\end{tabular}}\end{table}

\begin{table}[H]\centering\scriptsize\setlength{\tabcolsep}{3pt}
\caption{CIFAR-10, Solo redes convolucionales ($n{=}10$). Media [IC 95\,\%] sobre la validación cruzada repetida (AUC familiar y $\tau$) y sobre 300 remuestreos bootstrap (AUC por pares); $d$ de Cohen y prueba de Mann--Whitney entre familias extremas. Contrastes significativos tras Benjamini--Hochberg: 0/10 (Bonferroni: 0).}
\resizebox{\linewidth}{!}{\begin{tabular}{l c c c c c c c}\toprule
Descriptor & AUC familiar & AUC por pares & $\tau$ de Kendall & $p_\tau$ & $d$ de Cohen & $r_{\mathrm{MW}}$ & $p_{\mathrm{MW}}$ \\\midrule
$X_1$ (grafo funcional) & 1,000 [1,00; 1,00] & 0,806 [0,43; 1,00] & 0,576 [0,29; 0,78] & 0,0167 & n.\,d.\textsuperscript{*} & 0,00 & 1,0000 \\
$X_2$ (homología persistente) & 0,947 [0,71; 1,00] & 0,695 [0,20; 1,00] & 0,284 [$-$0,16; 0,58] & 0,0466 & n.\,d.\textsuperscript{*} & 1,00 & 0,3333 \\
$X_3^{(\mathrm{c})}$ (pesos iguales) & 0,986 [0,83; 1,00] & 0,693 [0,00; 1,00] & 0,344 [0,07; 0,56] & 0,1557 & n.\,d.\textsuperscript{*} & 1,00 & 0,3333 \\
$X_3^{(\mathrm{a})}$ (adaptativa) & 0,993 [0,96; 1,00] & 0,834 [0,36; 1,00] & 0,551 [0,31; 0,71] & 0,0167 & n.\,d.\textsuperscript{*} & 1,00 & 0,3333 \\
$X_3^{(\mathrm{r})}$ (adaptativa, ponderación por rangos) & 0,993 [0,96; 1,00] & 0,825 [0,40; 1,00] & 0,556 [0,31; 0,71] & 0,0091 & n.\,d.\textsuperscript{*} & 1,00 & 0,3333 \\
\bottomrule\end{tabular}}\end{table}

\begin{table}[H]\centering\scriptsize\setlength{\tabcolsep}{3pt}
\caption{CIFAR-10, Exactitud normalizada por tipo de red ($Y_{\mathrm{norm}}$). Media [IC 95\,\%] sobre la validación cruzada repetida (AUC familiar y $\tau$) y sobre 300 remuestreos bootstrap (AUC por pares); $d$ de Cohen y prueba de Mann--Whitney entre familias extremas. Contrastes significativos tras Benjamini--Hochberg: 9/10 (Bonferroni: 8).}
\resizebox{\linewidth}{!}{\begin{tabular}{l c c c c c c c}\toprule
Descriptor & AUC familiar & AUC por pares & $\tau$ de Kendall & $p_\tau$ & $d$ de Cohen & $r_{\mathrm{MW}}$ & $p_{\mathrm{MW}}$ \\\midrule
$X_1$ (grafo funcional) & 0,854 [0,81; 0,89] & 0,751 [0,58; 0,86] & 0,458 [0,40; 0,51] & $<$0,0001 & 2,91 [2,39; 4,63] & 1,00 & 0,0002 \\
$X_2$ (homología persistente) & 0,869 [0,83; 0,92] & 0,624 [0,46; 0,79] & 0,064 [$-$0,12; 0,21] & 0,4700 & 1,31 [0,83; 2,11] & 0,72 & 0,0073 \\
$X_3^{(\mathrm{c})}$ (pesos iguales) & 0,949 [0,92; 0,97] & 0,704 [0,54; 0,83] & 0,375 [0,29; 0,46] & $<$0,0001 & 3,52 [2,72; 5,85] & 1,00 & 0,0002 \\
$X_3^{(\mathrm{a})}$ (adaptativa) & 0,947 [0,91; 0,98] & 0,754 [0,60; 0,87] & 0,504 [0,42; 0,58] & $<$0,0001 & 3,35 [2,55; 5,33] & 1,00 & 0,0002 \\
$X_3^{(\mathrm{r})}$ (adaptativa, ponderación por rangos) & 0,947 [0,91; 0,98] & 0,766 [0,64; 0,88] & 0,504 [0,42; 0,58] & $<$0,0001 & 3,35 [2,59; 5,51] & 1,00 & 0,0002 \\
\bottomrule\end{tabular}}\end{table}

\subsection*{CIFAR-100}
Rango de exactitud de prueba en el dominio: 60,0 puntos porcentuales en total (26,8 entre perceptrones multicapa y 35,5 entre redes convolucionales).

\begin{table}[H]\centering\scriptsize\setlength{\tabcolsep}{3pt}
\caption{CIFAR-100, Población completa ($n{=}40$). Media [IC 95\,\%] sobre la validación cruzada repetida (AUC familiar y $\tau$) y sobre 300 remuestreos bootstrap (AUC por pares); $d$ de Cohen y prueba de Mann--Whitney entre familias extremas. Contrastes significativos tras Benjamini--Hochberg: 9/10 (Bonferroni: 8).}
\resizebox{\linewidth}{!}{\begin{tabular}{l c c c c c c c}\toprule
Descriptor & AUC familiar & AUC por pares & $\tau$ de Kendall & $p_\tau$ & $d$ de Cohen & $r_{\mathrm{MW}}$ & $p_{\mathrm{MW}}$ \\\midrule
$X_1$ (grafo funcional) & 0,778 [0,73; 0,82] & 0,588 [0,40; 0,75] & 0,129 [$-$0,01; 0,25] & 0,0370 & 0,56 [$-$0,30; 1,38] & 0,30 & 0,2730 \\
$X_2$ (homología persistente) & 0,870 [0,84; 0,90] & 0,757 [0,59; 0,88] & 0,509 [0,42; 0,57] & $<$0,0001 & 1,90 [1,16; 3,39] & 0,86 & 0,0013 \\
$X_3^{(\mathrm{c})}$ (pesos iguales) & 0,957 [0,93; 0,98] & 0,734 [0,52; 0,88] & 0,524 [0,40; 0,60] & $<$0,0001 & 2,29 [1,56; 3,84] & 0,88 & 0,0010 \\
$X_3^{(\mathrm{a})}$ (adaptativa) & 0,943 [0,91; 0,97] & 0,721 [0,52; 0,87] & 0,493 [0,43; 0,55] & $<$0,0001 & 1,76 [1,07; 2,90] & 0,86 & 0,0013 \\
$X_3^{(\mathrm{r})}$ (adaptativa, ponderación por rangos) & 0,943 [0,91; 0,97] & 0,718 [0,54; 0,86] & 0,493 [0,43; 0,55] & $<$0,0001 & 1,76 [1,10; 2,96] & 0,86 & 0,0013 \\
\bottomrule\end{tabular}}\end{table}

\begin{table}[H]\centering\scriptsize\setlength{\tabcolsep}{3pt}
\caption{CIFAR-100, Solo perceptrones multicapa ($n{=}30$). Media [IC 95\,\%] sobre la validación cruzada repetida (AUC familiar y $\tau$) y sobre 300 remuestreos bootstrap (AUC por pares); $d$ de Cohen y prueba de Mann--Whitney entre familias extremas. Contrastes significativos tras Benjamini--Hochberg: 8/10 (Bonferroni: 5).}
\resizebox{\linewidth}{!}{\begin{tabular}{l c c c c c c c}\toprule
Descriptor & AUC familiar & AUC por pares & $\tau$ de Kendall & $p_\tau$ & $d$ de Cohen & $r_{\mathrm{MW}}$ & $p_{\mathrm{MW}}$ \\\midrule
$X_1$ (grafo funcional) & 0,722 [0,62; 0,79] & 0,670 [0,43; 0,89] & 0,216 [0,02; 0,37] & 0,1083 & 0,56 [$-$0,40; 1,48] & 0,39 & 0,2593 \\
$X_2$ (homología persistente) & 0,864 [0,82; 0,90] & 0,689 [0,44; 0,89] & 0,357 [0,22; 0,46] & 0,0008 & 1,44 [0,70; 2,90] & 0,76 & 0,0175 \\
$X_3^{(\mathrm{c})}$ (pesos iguales) & 0,963 [0,93; 0,99] & 0,790 [0,63; 0,91] & 0,611 [0,49; 0,68] & $<$0,0001 & 2,74 [1,72; 6,32] & 1,00 & 0,0006 \\
$X_3^{(\mathrm{a})}$ (adaptativa) & 0,949 [0,90; 0,99] & 0,721 [0,49; 0,92] & 0,442 [0,32; 0,55] & 0,0008 & 0,88 [0,59; 2,36] & 0,76 & 0,0175 \\
$X_3^{(\mathrm{r})}$ (adaptativa, ponderación por rangos) & 0,949 [0,90; 0,99] & 0,708 [0,48; 0,92] & 0,442 [0,32; 0,55] & 0,0008 & 0,88 [0,56; 1,95] & 0,76 & 0,0175 \\
\bottomrule\end{tabular}}\end{table}

\begin{table}[H]\centering\scriptsize\setlength{\tabcolsep}{3pt}
\caption{CIFAR-100, Solo redes convolucionales ($n{=}10$). Media [IC 95\,\%] sobre la validación cruzada repetida (AUC familiar y $\tau$) y sobre 300 remuestreos bootstrap (AUC por pares); $d$ de Cohen y prueba de Mann--Whitney entre familias extremas. Contrastes significativos tras Benjamini--Hochberg: 5/10 (Bonferroni: 5).}
\resizebox{\linewidth}{!}{\begin{tabular}{l c c c c c c c}\toprule
Descriptor & AUC familiar & AUC por pares & $\tau$ de Kendall & $p_\tau$ & $d$ de Cohen & $r_{\mathrm{MW}}$ & $p_{\mathrm{MW}}$ \\\midrule
$X_1$ (grafo funcional) & 1,000 [1,00; 1,00] & 0,891 [0,60; 1,00] & 0,669 [0,42; 0,85] & 0,0009 & n.\,d.\textsuperscript{*} & 1,00 & 0,3333 \\
$X_2$ (homología persistente) & 0,999 [1,00; 1,00] & 0,908 [0,67; 1,00] & 0,776 [0,42; 0,89] & 0,0009 & n.\,d.\textsuperscript{*} & 1,00 & 0,3333 \\
$X_3^{(\mathrm{c})}$ (pesos iguales) & 0,893 [0,62; 1,00] & 0,925 [0,38; 1,00] & 0,821 [0,44; 0,96] & $<$0,0001 & n.\,d.\textsuperscript{*} & 1,00 & 0,3333 \\
$X_3^{(\mathrm{a})}$ (adaptativa) & 1,000 [1,00; 1,00] & 0,901 [0,50; 1,00] & 0,777 [0,64; 0,87] & 0,0004 & n.\,d.\textsuperscript{*} & 1,00 & 0,3333 \\
$X_3^{(\mathrm{r})}$ (adaptativa, ponderación por rangos) & 1,000 [1,00; 1,00] & 0,910 [0,55; 1,00] & 0,777 [0,64; 0,87] & 0,0004 & n.\,d.\textsuperscript{*} & 1,00 & 0,3333 \\
\bottomrule\end{tabular}}\end{table}

\begin{table}[H]\centering\scriptsize\setlength{\tabcolsep}{3pt}
\caption{CIFAR-100, Exactitud normalizada por tipo de red ($Y_{\mathrm{norm}}$). Media [IC 95\,\%] sobre la validación cruzada repetida (AUC familiar y $\tau$) y sobre 300 remuestreos bootstrap (AUC por pares); $d$ de Cohen y prueba de Mann--Whitney entre familias extremas. Contrastes significativos tras Benjamini--Hochberg: 9/10 (Bonferroni: 8).}
\resizebox{\linewidth}{!}{\begin{tabular}{l c c c c c c c}\toprule
Descriptor & AUC familiar & AUC por pares & $\tau$ de Kendall & $p_\tau$ & $d$ de Cohen & $r_{\mathrm{MW}}$ & $p_{\mathrm{MW}}$ \\\midrule
$X_1$ (grafo funcional) & 0,778 [0,73; 0,82] & 0,706 [0,51; 0,88] & 0,288 [0,17; 0,44] & 0,0001 & 0,53 [0,13; 1,66] & 0,44 & 0,1041 \\
$X_2$ (homología persistente) & 0,870 [0,84; 0,90] & 0,666 [0,48; 0,84] & 0,367 [0,21; 0,46] & 0,0019 & 0,99 [0,54; 2,18] & 0,64 & 0,0173 \\
$X_3^{(\mathrm{c})}$ (pesos iguales) & 0,957 [0,93; 0,98] & 0,772 [0,62; 0,90] & 0,549 [0,47; 0,61] & $<$0,0001 & 1,26 [0,26; 3,85] & 0,78 & 0,0036 \\
$X_3^{(\mathrm{a})}$ (adaptativa) & 0,948 [0,91; 0,98] & 0,732 [0,48; 0,89] & 0,504 [0,37; 0,60] & $<$0,0001 & 0,85 [0,64; 2,36] & 0,80 & 0,0028 \\
$X_3^{(\mathrm{r})}$ (adaptativa, ponderación por rangos) & 0,948 [0,91; 0,98] & 0,745 [0,55; 0,94] & 0,504 [0,37; 0,60] & $<$0,0001 & 0,85 [0,65; 2,33] & 0,80 & 0,0028 \\
\bottomrule\end{tabular}}\end{table}

\subsection*{SVHN}
Rango de exactitud de prueba en el dominio: 26,0 puntos porcentuales en total (16,5 entre perceptrones multicapa y 7,2 entre redes convolucionales).

\begin{table}[H]\centering\scriptsize\setlength{\tabcolsep}{3pt}
\caption{SVHN, Población completa ($n{=}40$). Media [IC 95\,\%] sobre la validación cruzada repetida (AUC familiar y $\tau$) y sobre 300 remuestreos bootstrap (AUC por pares); $d$ de Cohen y prueba de Mann--Whitney entre familias extremas. Contrastes significativos tras Benjamini--Hochberg: 10/10 (Bonferroni: 10).}
\resizebox{\linewidth}{!}{\begin{tabular}{l c c c c c c c}\toprule
Descriptor & AUC familiar & AUC por pares & $\tau$ de Kendall & $p_\tau$ & $d$ de Cohen & $r_{\mathrm{MW}}$ & $p_{\mathrm{MW}}$ \\\midrule
$X_1$ (grafo funcional) & 0,928 [0,89; 0,95] & 0,745 [0,60; 0,87] & 0,470 [0,41; 0,54] & $<$0,0001 & 1,68 [0,55; 5,51] & 0,80 & 0,0028 \\
$X_2$ (homología persistente) & 0,913 [0,88; 0,94] & 0,747 [0,58; 0,87] & 0,507 [0,44; 0,57] & $<$0,0001 & 2,31 [1,40; 4,02] & 0,86 & 0,0013 \\
$X_3^{(\mathrm{c})}$ (pesos iguales) & 0,972 [0,94; 1,00] & 0,762 [0,62; 0,88] & 0,470 [0,40; 0,55] & $<$0,0001 & 0,71 [$-$0,19; 3,76] & 0,80 & 0,0028 \\
$X_3^{(\mathrm{a})}$ (adaptativa) & 0,965 [0,94; 0,99] & 0,803 [0,68; 0,91] & 0,611 [0,53; 0,66] & $<$0,0001 & 3,86 [2,83; 6,40] & 1,00 & 0,0002 \\
$X_3^{(\mathrm{r})}$ (adaptativa, ponderación por rangos) & 0,965 [0,94; 0,99] & 0,795 [0,66; 0,90] & 0,611 [0,53; 0,66] & $<$0,0001 & 3,86 [2,83; 6,20] & 1,00 & 0,0002 \\
\bottomrule\end{tabular}}\end{table}

\begin{table}[H]\centering\scriptsize\setlength{\tabcolsep}{3pt}
\caption{SVHN, Solo perceptrones multicapa ($n{=}30$). Media [IC 95\,\%] sobre la validación cruzada repetida (AUC familiar y $\tau$) y sobre 300 remuestreos bootstrap (AUC por pares); $d$ de Cohen y prueba de Mann--Whitney entre familias extremas. Contrastes significativos tras Benjamini--Hochberg: 8/10 (Bonferroni: 4).}
\resizebox{\linewidth}{!}{\begin{tabular}{l c c c c c c c}\toprule
Descriptor & AUC familiar & AUC por pares & $\tau$ de Kendall & $p_\tau$ & $d$ de Cohen & $r_{\mathrm{MW}}$ & $p_{\mathrm{MW}}$ \\\midrule
$X_1$ (grafo funcional) & 0,875 [0,80; 0,93] & 0,633 [0,39; 0,85] & 0,188 [$-$0,03; 0,36] & 0,4788 & 1,04 [0,00; 2,79] & 0,63 & 0,0530 \\
$X_2$ (homología persistente) & 0,873 [0,82; 0,93] & 0,724 [0,56; 0,86] & 0,389 [0,29; 0,48] & 0,0067 & 2,47 [1,61; 5,36] & 0,92 & 0,0023 \\
$X_3^{(\mathrm{c})}$ (pesos iguales) & 0,958 [0,91; 0,99] & 0,666 [0,44; 0,87] & 0,345 [0,11; 0,48] & 0,0003 & 1,39 [0,55; 2,94] & 0,71 & 0,0262 \\
$X_3^{(\mathrm{a})}$ (adaptativa) & 0,938 [0,90; 0,97] & 0,679 [0,44; 0,88] & 0,413 [0,25; 0,54] & 0,0003 & 1,54 [0,73; 3,08] & 0,76 & 0,0175 \\
$X_3^{(\mathrm{r})}$ (adaptativa, ponderación por rangos) & 0,938 [0,90; 0,97] & 0,686 [0,46; 0,89] & 0,413 [0,25; 0,54] & 0,0003 & 1,54 [0,82; 3,13] & 0,76 & 0,0175 \\
\bottomrule\end{tabular}}\end{table}

\begin{table}[H]\centering\scriptsize\setlength{\tabcolsep}{3pt}
\caption{SVHN, Solo redes convolucionales ($n{=}10$). Media [IC 95\,\%] sobre la validación cruzada repetida (AUC familiar y $\tau$) y sobre 300 remuestreos bootstrap (AUC por pares); $d$ de Cohen y prueba de Mann--Whitney entre familias extremas. Contrastes significativos tras Benjamini--Hochberg: 0/10 (Bonferroni: 0).}
\resizebox{\linewidth}{!}{\begin{tabular}{l c c c c c c c}\toprule
Descriptor & AUC familiar & AUC por pares & $\tau$ de Kendall & $p_\tau$ & $d$ de Cohen & $r_{\mathrm{MW}}$ & $p_{\mathrm{MW}}$ \\\midrule
$X_1$ (grafo funcional) & 1,000 [1,00; 1,00] & 0,785 [0,33; 1,00] & 0,491 [0,18; 0,69] & 0,0286 & n.\,d.\textsuperscript{*} & 0,00 & 1,0000 \\
$X_2$ (homología persistente) & 1,000 [1,00; 1,00] & 0,720 [0,32; 1,00] & 0,284 [$-$0,09; 0,53] & 0,2164 & n.\,d.\textsuperscript{*} & 0,50 & 0,6667 \\
$X_3^{(\mathrm{c})}$ (pesos iguales) & 0,981 [0,83; 1,00] & 0,792 [0,33; 1,00] & 0,440 [0,11; 0,65] & 0,0726 & n.\,d.\textsuperscript{*} & 1,00 & 0,3333 \\
$X_3^{(\mathrm{a})}$ (adaptativa) & 1,000 [1,00; 1,00] & 0,763 [0,33; 1,00] & 0,425 [$-$0,00; 0,64] & 0,0466 & n.\,d.\textsuperscript{*} & 1,00 & 0,3333 \\
$X_3^{(\mathrm{r})}$ (adaptativa, ponderación por rangos) & 1,000 [1,00; 1,00] & 0,755 [0,33; 1,00] & 0,425 [$-$0,00; 0,64] & 0,0466 & n.\,d.\textsuperscript{*} & 1,00 & 0,3333 \\
\bottomrule\end{tabular}}\end{table}

\begin{table}[H]\centering\scriptsize\setlength{\tabcolsep}{3pt}
\caption{SVHN, Exactitud normalizada por tipo de red ($Y_{\mathrm{norm}}$). Media [IC 95\,\%] sobre la validación cruzada repetida (AUC familiar y $\tau$) y sobre 300 remuestreos bootstrap (AUC por pares); $d$ de Cohen y prueba de Mann--Whitney entre familias extremas. Contrastes significativos tras Benjamini--Hochberg: 8/10 (Bonferroni: 6).}
\resizebox{\linewidth}{!}{\begin{tabular}{l c c c c c c c}\toprule
Descriptor & AUC familiar & AUC por pares & $\tau$ de Kendall & $p_\tau$ & $d$ de Cohen & $r_{\mathrm{MW}}$ & $p_{\mathrm{MW}}$ \\\midrule
$X_1$ (grafo funcional) & 0,928 [0,89; 0,95] & 0,642 [0,47; 0,81] & 0,012 [$-$0,19; 0,19] & 0,2838 & 0,59 [$-$0,27; 1,86] & 0,36 & 0,1859 \\
$X_2$ (homología persistente) & 0,913 [0,88; 0,94] & 0,718 [0,54; 0,85] & 0,371 [0,27; 0,46] & 0,0002 & 1,59 [0,74; 3,06] & 0,74 & 0,0058 \\
$X_3^{(\mathrm{c})}$ (pesos iguales) & 0,972 [0,94; 1,00] & 0,667 [0,48; 0,84] & 0,373 [0,26; 0,48] & 0,0064 & 1,35 [0,39; 3,34] & 0,80 & 0,0028 \\
$X_3^{(\mathrm{a})}$ (adaptativa) & 0,963 [0,93; 0,98] & 0,683 [0,51; 0,83] & 0,401 [0,29; 0,50] & $<$0,0001 & 1,46 [0,59; 3,03] & 0,78 & 0,0036 \\
$X_3^{(\mathrm{r})}$ (adaptativa, ponderación por rangos) & 0,963 [0,93; 0,98] & 0,686 [0,47; 0,82] & 0,401 [0,29; 0,50] & $<$0,0001 & 1,46 [0,60; 3,17] & 0,78 & 0,0036 \\
\bottomrule\end{tabular}}\end{table}
